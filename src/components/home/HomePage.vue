...
//  document.querySelector(".navToggle").click(function () {
//    document.querySelector(".ham").classList.toggle("active");
//    document.querySelector(".header_mobile").classList.toggle("active-menu");
//    document.querySelector(".header").classList.toggle("active-menu")
//  });
//  document.querySelector(".header_search_cover .fa-magnifying-glass").click(function () {
//    document.querySelector(".search_header_cover").classList.toggle("active");
//  });
//});
...
.hide-menu__inner {
  ...
  display: none;
  box-shadow: 0 0 10px var(--shadow-small-content);
}
.post-options-item {
  font-size: 0.9rem;
}
...
.search-container input#search:active .icon {
  background: var(--content-color-hover) !important;
}
...
.header_mobile_item .fa-arrow-right {
  padding: 8px;
  border-radius: 50%;
  position: absolute;
  background: #fff;
...
.header_mobile_item_page_cover {
  padding-left: 15px;
}
.header_mobile_item_page_wrapper {
  background: rgb(255 255 255 / 20%);
  backdrop-filter: blur(20px);
  padding: 15px;
  display: flex;
...
.header_mobile_item_page {
  font-size: 18px;
  color: #fff;
  padding: 4px;
}
.header_mobile_item_page:hover {
...
.header_left .fa-magnifying-glass {
  font-size: 24px;
  color: #fff;
  cursor: pointer;
}
...
.main_parallax_img {
  background: url("@/components/img/background.png");
  background-size: cover;
  position: absolute;
...
.main_data_info_back i {
  margin-right: 6px;
}
.main_data_info_title {
  color: #fff;
...
.main_info_counter .container {
  display: flex;
}
.main_info_counter_item p {
  color: #fff;
  font-size: 16px;
}
.main_info_counter_item_number {
  font-size: 36px !important;
  font-weight: 700;
  padding-bottom: 8px;
  letter-spacing: 3px;
}
.main_info_counter_item {
  margin: 20px;
}
.main_info_counter_item_desc {
  font-size: 16px;
  color: #fff;
  font-weight: 400;
}
...
.main-info__red-ball {
  ...
  height: 19.5rem;
  width: 19.5rem;
  background-image: url("@/components/img/red-ball.png");
  background-repeat: no-repeat;
  background-size: contain;
  pointer-events: none;
}
.product {
  background: url("@/components/img/dot-grid.webp");
}
.product .container {
  position: relative;
}
...
.circle {
  ...
  width: 350px;
  position: relative;
  background: rgba(118, 154, 237, 0.5);
}
.circle:after {
  content: "";
  display: block;
  width: 100%;
  height: 100%;
  background: radial-gradient(ellipse at center, rgba(255,255,255,0) 0%,rgba(255,255,255,.8) 70%,rgba(255,255,255,.8) 100%);
  border-radius: 50%;
  position: absolute;
  top: 0; left: 0;
}
...
.product_item_desc {
  ...
  margin-top: 5px;
  color: var(--title-color);
  font-family: var(--title-font-semi);
}
.product_item:hover {
  transform: translateY(-10px);
}
.product_item:hover .product_item_img {
  box-shadow: var(--shadow-hover-content);
}
.product_more_btn {
  font-size: 18px;
  margin-top: 15px;
...
.reviews .container .main-info__red-ball {
  top: -6rem;
  left: -6rem;
  opacity: .5;
}
...
.reviews_wrapper {
  ...
  scrollbar-color: var(--inset-color) var(--content-color);
}
.reviews_wrapper:hover::-webkit-scrollbar {
  display: inline;
}
...
.reviews_wrapper::-webkit-scrollbar-track {
  background: var(--content-color);
}
.reviews_wrapper::-webkit-scrollbar-thumb {
...
.main_category_item:last-child {
  border-right: none;
}
.main_category_item i {
  position: absolute;
  border-radius: 50%;
...
.main_category_item:nth-child(1):hover {
  background: #0076E3;
}
.main_category_item:nth-child(2):hover {
  background: #FFE500;
  color: var(--title-color);
}
.main_category_item:nth-child(3):hover {
  background: #FFA800;
  color: var(--title-color);
}
.main_category_item:nth-child(4):hover {
  background: #12B064;
}
.main_category_item:nth-child(5):hover {
  background: #FE0000;
}
.main_category_item:nth-child(6):hover {
  background: #7000FE;
}
.main_category_item:hover i {
  background: #fff;
  color: #111;
}

/*single (contact)*/
.form_wrapper, .about_container {
  background: url("@/components/img/dot-grid.webp");
  padding-bottom: 20px;
}
.container_form {
...
.main_single {
  background: url("@/components/img/og-back.png");
}
.main_single_wrapper {
  padding-top: 180px;
}
.main_single_wrapper_title {
  font-size: 58px;
  color: #fff;
  font-family: var(--title-font-semi);
}
.main_single_wrapper_desc {
  color: #fff;
  font-size: 18px;
  padding-top: 8px;
  padding-bottom: 2px;
...
.page_catеgory_desc_item {
  width: 50%;
  padding: 30px;
}
.page_category_desc_count {
  font-size: 24px;
  font-family: var(--title-font-semi);
  font-weight: 600;
}
page_category_desc_data {
  font-size: 17px;
  font-weight: 400;
}
.page_category_image {
...
.page_category_wrapper {
  display: flex;
  flex-wrap: wrap;
  margin-top: -120px;
  padding-bottom: 80px;
}
.page_category_main_item {
  margin: 15px;
  width: calc(33.3% - 30px);
}
.page_category_main_item img {
  width: 280px;
  height: auto;
}
...
@media screen and (max-width: 790px) {
  .main .container, .reviews .container, .product .container, .contact .container {
    padding: 40px;
  }
  .main_data_info_title {
    font-size: 38px;
...
@media screen and (max-width: 600px) {
  ...
  .main_single .container, .container_form {
    padding: 40px;
  }
}
